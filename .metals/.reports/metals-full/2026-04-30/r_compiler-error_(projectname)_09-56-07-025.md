...
file://<WORKSPACE>/hw/spinal/filter/filter.scala
...
action parameters:
offset: 21
uri: file://<WORKSPACE>/hw/spinal/filter/filter.scala
text:
```scala
package pandasSpinal.@@
